...
([03-target/06-security.md](../docs/03-target/06-security.md#что-известно-о-текущем-состоянии)):
...
> ([05-freeze-policy.md](../docs/04-migration/05-freeze-policy.md#что-заморозка-не-запрещает-никогда)).

### TASK-1007. Уточнить требования к новой системе

**Приёмка:** [03-target/06-security.md](../docs/03-target/06-security.md)
