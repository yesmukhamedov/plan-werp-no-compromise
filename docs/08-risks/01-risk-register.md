...
Пересматривается ежемесячно ([05-plan/00-roadmap.md](../05-plan/00-roadmap.md#ритм)).
...
- **Если сработал:** пересмотр объёма — какие домены можно не переносить.
  Пересмотр стратегии на strangler fig ([ADR-0001](../02-decisions/ADR-0001-strategy-big-bang.md))
...
- **Действие:** [политика заморозки](../04-migration/05-freeze-policy.md);
...
Сценарий О3 ([04-migration/04-rollback.md](../04-migration/04-rollback.md#о3-откат-в-период-стабилизации))
...
- **Принят как остаточный риск** — это плата за [ADR-0001](../02-decisions/ADR-0001-strategy-big-bang.md).
...
неизвестно ([OQ-012](02-open-questions.md)).
...
- **Если сработал:** **проект встаёт.** Это осознанный механизм
  ([ADR-0003](../02-decisions/ADR-0003-backend-stack.md#последствия-откладывания)):
...
- **Действие:** выбор источника истины — решение владельца домена, принятое в
  Фазе 0 ([OQ-002](02-open-questions.md)); закладывать время на разбор в Фазе 2.
...
- **Действие:** правила исполняются машиной, а не людьми
  ([06-quality/01-test-strategy.md](../06-quality/01-test-strategy.md#что-проверяется-автоматически));
