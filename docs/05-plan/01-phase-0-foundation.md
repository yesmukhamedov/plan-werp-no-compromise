...
решается [ADR-0003](../02-decisions/ADR-0003-backend-stack.md), и не блокируется
им.
...
| 8 | Подтверждённая карта доменов | [03-target/02-domain-map.md](../03-target/02-domain-map.md) |
| 9 | Принятые ADR-0005, ADR-0007 | [02-decisions](../02-decisions/) |
| 10 | Прототипы на кандидатах стека, заполненная матрица | [ADR-0003](../02-decisions/ADR-0003-backend-stack.md#дальнейшие-шаги) |
