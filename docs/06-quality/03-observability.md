...
Требование [NC-10](../01-principles/01-no-compromise.md#nc-10). Текущее
состояние: 1 443 вызова `System.out.print*`, 31 `printStackTrace()`, печать SQL
включена во всех профилях ([P-07](../00-context/02-pain-points.md#p-07-диагностика-через-systemout)).
...
([04-migration/03-parity-verification.md](../04-migration/03-parity-verification.md#отчётность)).
...
- Идентификатор трассировки возвращается клиенту в ответе об ошибке
  ([03-target/03-api-contract.md](../03-target/03-api-contract.md#ошибки)) —
