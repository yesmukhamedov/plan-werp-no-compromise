...
1. **Планка допуска к переезду** ([01-cutover-strategy.md](01-cutover-strategy.md#условия-допуска-к-переезду))
...
**Это принятый риск [R-03](../08-risks/01-risk-register.md#r-03).** Он записан
явно, а не спрятан.
