...
и подтверждённого состава команды ([OQ-001](../08-risks/02-open-questions.md)).
...
| [03-target/01-architecture.md](../03-target/01-architecture.md) | механизм изоляции модулей, способ внутримодульного взаимодействия |
| [03-target/04-data-model.md](../03-target/04-data-model.md) | механизм доступа к данным, инструмент миграций, механизм аудита |
| [06-quality/01-test-strategy.md](../06-quality/01-test-strategy.md) | фреймворк тестирования, инструмент контейнеров для интеграционных тестов |
| [06-quality/03-observability.md](../06-quality/03-observability.md) | библиотека журналирования и экспортёр метрик |
| [07-ops/02-cicd.md](../07-ops/02-cicd.md) | шаги сборки, кэш зависимостей, базовый образ |
| [05-plan/02-phase-1-platform.md](../05-plan/02-phase-1-platform.md) | вся фаза целиком: платформа строится на выбранном стеке |
| [05-plan/07-estimates.md](../05-plan/07-estimates.md) | коэффициент трудоёмкости переноса домена |
...
- Оценки в [05-plan/07-estimates.md](../05-plan/07-estimates.md) даны в диапазоне,
