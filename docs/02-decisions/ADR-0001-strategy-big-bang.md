...
→ [04-migration/05-freeze-policy.md](../04-migration/05-freeze-policy.md)
...
из эксплуатации.
→ [04-migration/04-rollback.md](../04-migration/04-rollback.md)

## Последствия

- Появляется [Фаза 4](../05-plan/05-phase-4-parity-and-cutover.md) — паритет и
...
- Порядок разработки доменов определяется не бизнес-приоритетом, а зависимостями:
  ...
  → [05-plan/03-phase-2-domains.md](../05-plan/03-phase-2-domains.md)
...
- Обратная связь от пользователей поступает через регулярные демонстрации на
  ...
  а не пожелание.
- Риски [R-01](../08-risks/01-risk-register.md#r-01) (растяжение сроков),
  [R-02](../08-risks/01-risk-register.md#r-02) (движущаяся цель) и
  [R-03](../08-risks/01-risk-register.md#r-03) (неудачный переезд) получают
